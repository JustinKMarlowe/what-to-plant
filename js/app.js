...
const app = {
  ...
  /** "Find My Plants" button — uses today's date */
  async start() {
    ...
    return `
      <div class="plant-card" style="animation-delay: ${index * 0.08}s">
        <img class="plant-card-img"
             ...
             alt="${plant.name}"
             loading="lazy"
             onerror="this.src='data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 400 200%22><rect fill=%22%23e8d5b7%22 width=%22400%22 height=%22200%22/><text x=%2250%25%22 y=%2250%25%22 dominant-baseline=%22middle%22 text-anchor=%22middle%22 font-size=%2240%22>🌱</text></svg>'" />
